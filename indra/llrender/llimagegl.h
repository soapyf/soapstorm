...
public:
    ...
    // Coarsest discard level whose "not a mask" verdict from analyzeAlpha is trusted (finer levels are also trusted; coarser uploads are provisional). doc/alpha_mask_verdict.md
