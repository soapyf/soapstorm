...
// [/RLVa:KB]
    ...
    LLFloaterReg::add("fs_sound_emitter_blacklist", "floater_fs_sound_emitter_blacklist.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<FSFloaterSoundEmitterBlacklist>);
